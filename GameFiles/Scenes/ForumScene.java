...
public class ForumScene extends AScene {
    ...
    public void Update() throws SQLException {
        ...
        //RÃ©cupÃ©ration de la derniÃ¨re entrÃ©e souris
    ...
    /*NOTE IMPORTANTE :
     * J'ai sÃ©parÃ© les deux parties Student et Teacher pour que ce soit plus simple de se retrouver dans le code
     * La partie Student peut donc servir d'exemple pour la crÃ©ation de la partie Teacher 
     */
        ...
        addQuestionButton = new Button(new Rectangle(250, 500, 100, 50), "Add question", () -> {
            try {
                if (question.GetText().length() != 0){
                    //VÃ©rification de l'existence de la question
                    ...
                    if (questionSet.next()){
                        ...
                        //RÃ©cupÃ©ration de l'id du l'utilisateur
        ...
        addPropositionButton = new Button(new Rectangle(250, 500, 100, 50), "Add proposition", () -> {
            try {
                if (proposition.GetText().length() != 0){
                    //Insertion de la proposition de rÃ©ponse, pas de vÃ©rification d'existence car les Ã©tudiants n'ont pas accÃ¨s aux autres propositions
    ...
    private void UpdateStudent(CoreSystem.Mouse.EventType e) throws SQLException {
        //Ici, l'Update dÃ©pend de l'Ã©cran en cours dans la scÃ¨ne. Il n'y a pas grand chose Ã  part les Update de base des menus
    ...
    private void ResetStudentQuestionDeleteList() throws SQLException {
        ...
        while (questionDeleteSet.next()){
            ...
            //On ajoute tous les couples TextBox Button Ã  partir de la base de donnÃ©es. Le bouton va enclencher la fonction en Lambda (suppression de la question).
            questionDeleteArray.get(i/5).put(new TextBox(new Rectangle(50, 50 + (i % 5) * 75, 400, 50), questionDeleteSet.getString("question")), new Button(new Rectangle(500, 50 + (i % 5) * 75, 100, 50), "Delete", () -> {
                try {
                    //On supprime toutes les propositions Ã  la quesiton, puis on supprime la question. Enfin, on fait un reset la liste des boutons
